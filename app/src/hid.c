...
struct zmk_hid_touchpad_mouse_report touchpad_report = {
    .report_id = ZMK_REPORT_ID_TOUCHPAD_MOUSE,
...
void zmk_hid_touchpad_mouse_set(uint8_t buttons, int8_t xDelta, int8_t yDelta, int8_t scrollDelta) {
    touchpad_report.body.buttons = buttons;
    touchpad_report.body.xDelta = xDelta;
    touchpad_report.body.yDelta = yDelta;
    touchpad_report.body.scrollDelta = scrollDelta;
}
#endif
